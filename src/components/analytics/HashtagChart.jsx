import useHashtagVisualization from '@/hooks/useHashtagVisualization';
import React from 'react';
import Loading from '../common/Loading';
import Image from 'next/image';

const HashtagChart = ({ hashtag }) => {
  const { data, loading, error } = useHashtagVisualization({ hashtag });

  if (loading) {
    return <Loading statusMessage="Loading video by hashtag analytics..." />;
  }
